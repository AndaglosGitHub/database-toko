...
class TriggerSimklinik extends Migration {
    ...
    public function up()
    {
        ...
        DB::unprepared('
           CREATE TRIGGER `hapus_data_detail_pembayaran_hutang` AFTER INSERT ON `history_detail_pembayaran_hutang` FOR EACH 
                BEGIN
        ...
        DB::unprepared('   
           CREATE TRIGGER `hapus_data_detail_item_masuk` AFTER INSERT ON `history_detail_item_masuk` FOR EACH 
                BEGIN
        ...
        DB::unprepared('   
           CREATE TRIGGER `delete_tbs_retur_jual` AFTER DELETE ON `retur_penjualan` FOR EACH 
                BEGIN
                DELETE FROM tbs_retur_penjualan WHERE no_faktur_retur = old.no_faktur_retur
                END
        ');
        ...
        DB::unprepared('   
           CREATE TRIGGER `hapus_data_detail_kas_masuk` AFTER INSERT ON `history_detail_kas_masuk` FOR EACH 
                BEGIN
        ...
        DB::unprepared('  
           CREATE TRIGGER `hapus_data_detail_kas_keluar` AFTER INSERT ON `history_detail_kas_keluar` FOR EACH 
                BEGIN
        ...
        DB::unprepared('   
           CREATE TRIGGER `hapus_jurnal_kas_keluar` AFTER DELETE ON `detail_kas_keluar` FOR EACH 
            BEGIN
                DELETE FROM jurnal_trans WHERE no_faktur = old.no_faktur
            END
        '),
        ...
        DB::unprepared('   
           CREATE TRIGGER `hapus_jurnal_kas_masuk` AFTER DELETE ON `detail_kas_masuk` FOR EACH 
            BEGIN
                DELETE FROM jurnal_trans WHERE no_faktur = old.no_faktur
            END
        '),
        ...
        DB::unprepared('   
           CREATE TRIGGER `hapus_jurnal_kas_mutasi` AFTER DELETE ON `kas_mutasi` FOR EACH 
            BEGIN
                DELETE FROM jurnal_trans WHERE no_faktur = old.no_faktur
            END
        '),
        ...
        DB::unprepared('   
           CREATE TRIGGER `hapus_jurnal_pembayaran_piutang` AFTER DELETE ON `pembayaran_piutang` FOR EACH 
            BEGIN
        ...
        DB::unprepared('   
           CREATE TRIGGER `hapus_jurnal_trans` AFTER INSERT ON `history_jurnal_manual` FOR EACH 
            BEGIN
        ...
        DB::unprepared('   
           CREATE TRIGGER `hapus_jurnal_transaksi` AFTER DELETE ON `pembayaran_hutang` FOR EACH 
            BEGIN         
                DELETE FROM jurnal_trans WHERE no_faktur = old.no_faktur_pembayaran;
